...
#define TOTAL_CONNECTIONS 0x01
#define CURRENT_CONNECTIONS 0x02
#define MAX_CURRENT_CONNECTIONS 0x03
#define TOTAL_BYTES_SENT 0x04
#define TOTAL_BYTES_RECV 0x05
#define CONNECTED_USERS 0x06
